...
/* 본문 영역 여백/리듬 */
.main .block-container { max-width: 940px !important; padding: 2.5rem 2rem 4rem !important; }
...
if header_video_b64:
    ...
    .writey-divider {{ width:36px; height:1px; background:#C9A24B; margin:22px auto 0; }}
    .writey-tagline {{
    ...
    <div style="position:relative;border-radius:16px;overflow:hidden;margin-bottom:35px;border:0.5px solid rgba(201,162,75,0.18);">
        ...
        <div style="position:absolute;top:0;left:0;right:0;bottom:0;display:flex;flex-direction:column;justify-content:center;align-items:center;text-align:center;">
            <div class="writey-eyebrow">A I&nbsp;&nbsp;G H O S T W R I T E R</div>
            <h1 class="writey-title">WRITEY</h1>
            <div class="writey-divider"></div>
    ...
    <div style="text-align:center;padding:56px 20px 44px;margin-bottom:30px;background:#0B0B0D;border-radius:16px;border:0.5px solid rgba(201,162,75,0.18);">
        <div style="font-size:12px;letter-spacing:0.4em;color:#C9A24B;margin-bottom:16px;">A I&nbsp;&nbsp;G H O S T W R I T E R</div>
