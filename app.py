...
《예시 A · 월배당 투자》
PART 1. 고배당만 좇다 3년을 날린 사람들
- 매달 현금은 들어오는데 잔고는 늘 그대로인 이유
- 배당률이 높을수록 더 위험한 종목인 까닭
- "일단 모으자"는 조급함이 가장 먼저 무너진다
- 결국 답은 '○○○' 하나였다
PART 2. 잘 버는 사람은 배당률부터 보지 않는다
- 수익률보다 '언제 들어오느냐'를 먼저 따진다
- 종목 네 개로 비는 달 없이 받는 법
- 고배당주를 피한 사람이 오히려 더 벌었다
- 폭락에 팔지 않고 더 산 쪽이 먼저 회복한다
PART 3. 첫 배당 47만원이 들어온 날
- 월급 아닌 돈이 처음 생긴 그 아침
- ○○○를 적용한 사람들이 가장 먼저 바꾼 것
- 이 시기를 놓치면 1년이 그냥 흐른다
- 한 번 맛본 사람은 원금에 만족하지 못한다
PART 4. 자는 사이에도 돈이 들어오기 시작한다
- 배당을 다시 넣은 사람만 받는 액수가 커진다
- 월 백을 넘긴 뒤 가장 먼저 끊은 습관
- 계좌를 덜 본 해에 오히려 수익이 높았던 사실
- 폭락장에도 흔들리지 않는 계좌의 공통점
PART 5. 월급을 넘어선 다음, 시간까지 번다
- 더 넣은 사람과 중간에 멈춘 사람의 5년 뒤 격차
- 돈과 자유가 같이 따라오는 지점
- 직장을 그만둔 사람들이 마지막에 똑같이 한 일
- ○○○로 자리잡은 이들이 다시는 안 돌아가는 이유

《예시 B · 멘탈 관리》
PART 1. 1년 안에 99%가 다시 무너지는 이유
- 마음을 백 번 다잡아도 사흘이면 원점인 까닭
- 의지가 강한 사람일수록 더 크게 흔들린다
- "긍정적으로 생각하라"가 오히려 독이 되는 순간
- 여기서부터 '○○○'가 시작된다
PART 2. 의지로 잡으려 할수록 뇌는 반대로 간다
- 감정이 터질 때 뇌가 가장 먼저 멈추는 지점
- 참을수록 더 크게 폭발하는 사람들의 공통점
- 명상도 운동도 나에게만 안 통한 진짜 원인
- 무너진 다음 날 가장 먼저 해야 할 한 가지
PART 3. 처음으로 멀쩡하게 넘긴 그날
- 폭발 직후 90초가 회복의 8할을 가른다
- ○○○를 처음 써본 사람들이 느낀 변화
- 이 순간을 놓치면 며칠을 다시 잃는다
- 단번에 가라앉히는 사람들이 무심코 하는 행동
PART 4. 한 번 회복한 뇌는 같은 일에 흔들리지 않는다
- 같은 일을 겪어도 더는 휘둘리지 않게 된다
- 무너지는 횟수가 한 달 만에 절반으로 준다
- 단단해진 사람이 더는 하지 않는 행동들
- 주변에서 "달라졌다"는 말을 듣는 시점
PART 5. 단단한 멘탈이 인생 전체를 바꾼다
- 멘탈이 바뀌자 통장과 관계가 같이 달라졌다
